...
const DETAILS_STATES = [
  ...
  { kind: 'form', name: 'Toufeeq Ahamed', gender: 'male', loading: true, submitStatus: 'Following your masjid · 2 of 3', name_: 'Details — following' },
  { kind: 'form', name: 'Toufeeq Ahamed', gender: 'male', loading: true, submitStatus: 'Finishing setup · 3 of 3', name_: 'Details — finishing' },
...
function DetailsRow({ active = -1, onSelectFrame }) {
  ...
  return (
    <div>
      <div className="poc-row-label"><span className="mi" data-i="person"></span> 01 · PERSONAL DETAILS · 8 STATES</div>
                ...
                <div className="noor-frame-inner">
                  <div className="noor-screen">
                    ...
                    {s.kind === 'success'
                      ...
                      : (PersonalDetailsScreen && <PersonalDetailsScreen name={s.name} gender={s.gender} nameError={!!s.nameError} genderError={!!s.genderError} loading={!!s.loading} submitStatus={s.submitStatus} serviceError={!!s.serviceError} />)}
