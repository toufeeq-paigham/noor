...
const INTRO_SLIDES = [
  { name: 'Qaum', img: '../../images/intro_qaum.webp', pos: 'center top',
  ...
  { name: 'Salaah', img: '../../images/intro_salaah.webp', pos: 'center',
  ...
  { name: 'Ibadah', img: '../../images/intro_ibadah.webp', pos: 'center',
    gradient: 'linear-gradient(to bottom,rgba(0,0,0,0.04) 0%,rgba(0,0,0,0.1) 38%,rgba(0,0,0,0.48) 62%,rgba(0,0,0,0.74) 80%,rgba(0,0,0,0.84) 100%)',
