...
export function AndroidPhone({ src, alt = "", style, hideEmpty }: FrameProps) {
  const resolved = img(src);
  return (
    <div style={{ position: "relative", aspectRatio: "705 / 1469", ...style }}>
      <div
        style={{
          width: "100%",
          height: "100%",
          borderRadius: "10.4% / 5%",
          background: "linear-gradient(145deg, #55565b 0%, #1a1b1f 34%, #0c0d10 72%, #36373c 100%)",
          boxShadow:
            "inset 0 0 0 1px rgba(255,255,255,0.18), inset 0 0 0 2px rgba(0,0,0,0.35), 0 14px 40px rgba(0,0,0,0.36)",
          position: "relative",
          overflow: "hidden",
        }}
      >
        <div
          style={{
            ...
            background: "linear-gradient(90deg, #25262a, #4a4b50)",
            zIndex: 4,
          }}
        />
        <div
        ...
        <div
          style={{
            ...
            aspectRatio: "1 / 1",
            borderRadius: "50%",
            background: "radial-gradient(circle at 42% 38%, #1a2029 0%, #08090b 44%, #000 100%)",
